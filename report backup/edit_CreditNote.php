...
<select id="txt_status" name="txt_status" <?if($fil['CN_id'] <> "3" or  $userType2!=" 7_6"){echo 'disabled';} ?> >
...
<input type="text" size="50" id="txt_remark" name="txt_remark" value="<? echo $fil['CN_Remark'];?>" 
 <?if($fil['CN_id']<> "3" or   $userType2!=" 7_6"){echo 'disabled';} ?>>
</tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2" align="left" ><input type="hidden" id="hd_cmd"  name="hd_cmd" />
<? if($fil['CN_id']== "3" and   $userType2 =="7_6"){ ?>
